...
export function initializeScene() {
    return new Promise((resolve, reject) => {
        ...
        const diffuseMap = textureLoader.load('https://demo-skycrab.s3.eu-north-1.amazonaws.com/low_Cattedrale_decimata_u0_v0_diffuse.png');
        const normalMap = textureLoader.load('https://demo-skycrab.s3.eu-north-1.amazonaws.com/low_Cattedrale_decimata_u0_v0_normal.png');
